...
var TestPhaseFeedbackComponent = (function () {
    function TestPhaseFeedbackComponent(wordPairService, router, route) {
    ...
    //   );
    // }
    TestPhaseFeedbackComponent.prototype.submitPair = function () {
    ...
    // }
    TestPhaseFeedbackComponent.prototype.resetTimer = function () {
        var _this = this;
    ...
    //
    // }
    TestPhaseFeedbackComponent.prototype.cycleWords = function () {
        var _this = this;
        this.timer = setTimeout(function () { return _this.submitPair(); }, 5000); // TESTING TIME
    };
    TestPhaseFeedbackComponent.prototype.ngOnInit = function () {
        this.i = 0;
        this.responseTime = Date.now();
        this.cycleWords();
    };
    ...
    ], TestPhaseFeedbackComponent.prototype, "response", void 0);
    __decorate([
        core_1.Input()
    ], TestPhaseFeedbackComponent.prototype, "wordPairs", void 0);
    __decorate([
        core_1.Input()
    ], TestPhaseFeedbackComponent.prototype, "testPhase", void 0);
    TestPhaseFeedbackComponent = __decorate([
        core_1.Component({
    ...
    return TestPhaseFeedbackComponent;
}());
exports.TestPhaseFeedbackComponent = TestPhaseFeedbackComponent;
